...
public class Main extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Button mBasicButton = (Button) findViewById(R.id.basic);
        mBasicButton.setOnClickListener(accountListener);

        Button mWindowsButton = (Button) findViewById(R.id.windows);
        mWindowsButton.setOnClickListener(accountListener);

        Button mDeviceButton = (Button) findViewById(R.id.device);
